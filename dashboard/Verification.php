...
<div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-5">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="AdminDash.php">Verifications</a></li>
          </ol>
        </div>
  ...
  <div class="container-fluid">
    <div class="edit-profile">
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-header pb-0">
              <h4 class="card-title mb-0">All Verified</h4>
            ...
            <div class="card-body">
              <table class="table">
                ...
                <?php
                  $i=1;
               $sql="SELECT * from login where VStatus='1'";
      ...
      <td><span ><?php if($row['VStatus']==0){echo"Pending";}else if($row['VStatus']==1){echo"Verified";} ?></span></td>
  ...
  <?php $i++;}}
     ...
     echo "No record Found!";
        ...
        <div class="col-xl-8">
          <form class="card">
            <div class="card-header pb-0">
              <h4 class="card-title mb-0">Pending Verification</h4>
              <div class="card-options"><a class="card-options-collapse" href="#" data-bs-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a><a class="card-options-remove" href="#" data-bs-toggle="card-remove"><i class="fe fe-x"></i></a></div>
            </div>
            <table class="table">
                          <thead>
                          ...
                          <?php
                          $i=1;
                       $sql="SELECT * from login where role='2' or role='3'";
                       $query = mysqli_query($link,$sql);
                        if(mysqli_num_rows($query)>0){
