                  ...
                  <div class="card mb-0">
                    ...
                    <div class="table-data">
                      <div class="order">
                        ...
                        $sql="select cusreq.cusid,login.fname,login.Date,cusreq.planfor,cusreq.budget,cusreq.CusReqStatus from cusreq INNER JOIN login on cusreq.login_id=login.login_id where cusreq.CusReqStatus='0'"; 
