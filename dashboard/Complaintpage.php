      ...
      <div class="row">
        <div class="col-sm-5">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="AdminComp.php">Complaints</a></li>
          </ol>
        </div>
                        ...
                        <table class="table">
                          <thead>
                            <tr>
                              ...
                              <th>User Name</th>
                              <th>Date</th>
                              <th>Complainter Role</th>
                              <th>Complaint Against</th>
                            </tr>
                          </thead>
                          <?php
                          $i=1;
                          // $sql="select complaint.compid,login.fname,complaint.CompDate,complaint.CompAgainst=login.fname,complaint.CompStatus from complaint INNER JOIN login on complaint.login_id=login.login_id"; 
$sql="Select * from complaint join login on complaint.login_id=login.login_id";
                      //  $sql="SELECT * FROM `complaint` join `login` on complaint.login_id = login.login_id where complaint.login_id = '$id';";
            ...
            <tr>
              ...
              <?php               
              $cid = $row['CompAgainst'];
              $sql2="Select fname as f from login where login_id=$cid";      
              $query2 = mysqli_query($link,$sql2);
                        
              while($row2=mysqli_fetch_assoc($query2)){?>
              <td><?php echo $row2['f'];?></td>
<?php } ?>
           <td><a href="VeriArc.html">View</a> </td>
            </tr>
          <?php $i++;}}
          else{
