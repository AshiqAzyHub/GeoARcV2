      ...
      <div class="page-body-wrapper sidebar-icon">
        ...
        <header class="main-nav">
          ...
          <div class="sidebar-user text-center">
              ...
              <div class="badge-bottom"><span class="badge badge-primary"><?php echo $_SESSION['role']; ?></span></div>
    ...
    <div class="page-header">
      <div class="row">
        <div class="col-sm-5">
          <h3>Home</h3>
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="ArcDash.php">Home</a></li>
          </ol>
        </div>
        ...
        <div class="col-xl-4">
          <div class="card">
            <div class="card-header pb-0">
              ...
              <a href="CusGetVeri.php"> <h6 class="mt-3 f-14 f-w-600">Get Verified</h6></a>
