...
session_start();
    ...
    if(isset($_GET['cid'])){
        ...
        $a = "UPDATE cusreq SET CusReqStatus=1 where cusid= $cid";
        $b = "UPDATE cusreq SET accby= $id where cusid=$cid";
        mysqli_query($link, $a);
        mysqli_query($link, $b);
          ...
          <div class="card email-body radius-left">
            <div class="ps-0">
              <div class="tab-content">
                      ...
                      <div class="order">
                        <table class="table" method="post">
                          ...
                          <?php
                           $aid = intval($_GET['aid']);
                            $i=1;
                         $sql="select cusreq.cusid,login.fname,login.Date,cusreq.planfor,cusreq.rooms,cusreq.toilet,cusreq.location,cusreq.contact,cusreq.AddInfo,cusreq.budget,cusreq.CusReqStatus from cusreq INNER JOIN login on cusreq.login_id=login.login_id where cusreq.cusid=$aid"; 
                         ...
                         ?> 
                            ...
                            <tr><th>Design for</th>                <td><span ><?php if($row['planfor']==1){echo"Home";}else if($row['planfor']==2){echo"banglow";}else if($row['planfor']==3){echo"school";} else if($row['planfor']==4){echo"apartment";} ?></span></td>
                            ...
                            <tr><th>Budget</th>                <td><span ><?php if($row['budget']==1){echo"1-50";}else if($row['budget']==2){echo"1 cr";}else if($row['budget']==3){echo"5 cr";} else if($row['budget']==4){echo"10+ cr";} ?></span></td>
                ...
                <?php if($row['CusReqStatus']==0) { ?>
                <td> <a href="ViewReq.php?cid=<?php echo $row['cusid'];?>" ><li class="onhover-dropdown p-0">
                <button class="btn btn-primary-light" type="button"><i></i>Accept</button> <?php }
                else{
                   ?>
                    <td><li class="onhover-dropdown p-0">
                    <button class="btn btn-primary-light" type="button"><i data-feather="check-circle"></i>Accepted</button>
                <?php }?>
        </li>
        </a> </td>
              </tr>
