          ...
          <div class="card email-body radius-left">
            <div class="ps-0">
              <div class="tab-content">
                <div class="tab-pane fade active show" id="pills-personal" role="tabpanel" aria-labelledby="pills-personal-tab">
                  <div class="card mb-0">
                    <div class="card-header d-flex">
                      <h5>Design Requests Completed</h5>
                    </div>
                    ...
                    <div class="table-data">
                      <div class="order">
                        ...
                        // $sql="select cusreq.cusid,cusreq.Completed,login.fname,login.Date,cusreq.planfor,cusreq.budget,cusreq.CusReqStatus from cusreq INNER JOIN login on cusreq.login_id=login.login_id where cusreq.CusReqStatus='1'"; 
                        $sql="select cusreq.cusid,cusreq.Completed,login.fname,login.Date,cusreq.planfor,cusreq.rooms,cusreq.toilet,cusreq.location,cusreq.contact,cusreq.AddInfo,cusreq.budget,cusreq.CusReqStatus from cusreq INNER JOIN login on cusreq.login_id=login.login_id where cusreq.accby=$id and cusreq.Completed='1'"; 
                ...
                <td><span ><?php if($row['Completed']==0){echo"Pending";}else if($row['Completed']==1){echo"Completed";} ?></span></td>
                <td><a href="ViewReq2.php?aid=<?php echo $row['cusid'];?>">View</a> </td>
              </tr>
            <?php $i++;}}
            else{
