                  ...
                  <div class="card mb-0">
                    ...
                    <div class="table-data">
                      <div class="order">
                        ...
                        $sql="select cusreq.cusid,cusreq.Completed,login.fname,login.Date,cusreq.planfor,cusreq.rooms,cusreq.toilet,cusreq.location,cusreq.contact,cusreq.AddInfo,cusreq.budget,cusreq.CusReqStatus from cusreq INNER JOIN login on cusreq.login_id=login.login_id where cusreq.accby=$id"; 
