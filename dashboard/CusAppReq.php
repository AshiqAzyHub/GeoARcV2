          ...
          <div class="card email-body radius-left">
            <div class="ps-0">
                    ...
                    <div class="table-data" >
                      <div class="order">
                        ...
                        <table class="table">
                          ...
                          <?php
                            $i=1;
                        $sql="select cusreq.cusid,cusreq.Completed,login.fname,login.Date,cusreq.planfor,cusreq.budget,cusreq.CusReqStatus from cusreq INNER JOIN login on cusreq.login_id=login.login_id where cusreq.login_id=$id "; 
              ...
              <tr>
                ...
                <td><a href="ViewArc.php?aid=<?php echo $row[$id];?>">View</a> </td>
              </tr>
            <?php $i++;}}
            else{
