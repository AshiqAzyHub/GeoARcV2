          ...
          <div class="card email-body radius-left">
            <div class="ps-0">
              <div class="tab-content">
                    ...
                    <div class="table-data">
                      <div class="order">
                        ...
                        //  $sql="SELECT * from login,cusreq where cusreq.CusReqStatus='0'";
                         $sql="select login.fname,login.Date,cusreq.planfor,cusreq.budget,cusreq.CusReqStatus from cusreq INNER JOIN login on cusreq.login_id=login.login_id where cusreq.CusReqStatus='1'"; 
                ...
                <td><a href="AccReqView.php">View</a> </td>
              </tr>
            <?php $i++;}}
            else{
