...
if($_SESSION['email']=="")
    if(isset($_GET['aid'])){
        ...
        $a = "UPDATE cusreq SET CusReqStatus=1 where id= $aid";
        mysqli_query($link, $a);
                ...
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="nav-submenu menu-content" style="display: block;">
                            ...
                            <li><a href="AccReq.php" class="">Accepted</a></li>
                        </ul>
                    </li>
                    ...
                    <div class="table-data">
                      <div class="order">
                        <table class="table" method="post">
                          ...
                          <?php
                            $i=1;
                         $sql="select login.fname,login.Date,cusreq.planfor,cusreq.rooms,cusreq.toilet,cusreq.location,cusreq.contact,cusreq.AddInfo,cusreq.budget,cusreq.CusReqStatus from cusreq INNER JOIN login on cusreq.cusid=login.login_id where cusreq.CusReqStatus='0'"; 
