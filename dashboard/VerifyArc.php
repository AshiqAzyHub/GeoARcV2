...
session_start();
  if(isset($_GET['cid'])){
    ...
    $a = "UPDATE login SET VStatus=1 where login_id= $cid";
    mysqli_query($link, $a);
        ...
        <div class="main-navbar">
            ...
            <div id="mainnav">
                <ul class="nav-menu custom-scrollbar">
                    ...
                    <li class="dropdown">
                        <a class="nav-link menu-title active" href="AdminDash.html"><i data-feather="home"></i><span>Dashboard</span></a>                  
                         ...
                         ?>   
                          <thead >
                            <tr>
                              ...
                              <tr> <th>Documents</th>                
                              <td><?php echo $row['docs'];?></td> </tr>

                              <tr> <th>Status</th>                
                              <td><span ><?php if($row['VStatus']==0){echo"Not Verified";}else if($row['VStatus']==1){echo"Verified";} ?></span></td></tr>
                 <tr><th></th>
                              <?php if($row['VStatus']==0) { ?>
                <td><a href="VerifyArc.php?cid=<?php echo $row['login_id'];?>" ><li class="onhover-dropdown p-0">
                <button class="btn btn-primary-light" type="button"><i></i>Verify</button> <?php }
                else{
                   ?>
                    <td><li class="onhover-dropdown p-0">
                    <button class="btn btn-primary-light" type="button"><i data-feather="check-circle"></i>Verified</button>
                <?php }?>
        </li>
        </a> </td>
              </tr>
